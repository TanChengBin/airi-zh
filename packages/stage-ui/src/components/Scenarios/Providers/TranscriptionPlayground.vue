...
<template>
  <div w-full pt-1>
    ...
    <Button class="my-4" w-full @click="toggleMonitoring">
      {{ isMonitoring ? t('settings.pages.providers.provider.common.fields.field.transcription.monitoring.stop') : t('settings.pages.providers.provider.common.fields.field.transcription.monitoring.start') }}
    </Button>
    ...
    <div class="space-y-3">
      <!-- Volume Meter -->
      <LevelMeter :level="volumeLevel" :label="t('settings.pages.providers.provider.common.fields.field.transcription.input-level.label')" />

      <!-- VAD Probability Meter (when VAD model is active) -->
      <ThresholdMeter
        :value="volumeLevel / 100"
        :threshold="speakingThreshold / 100"
        :label="t('settings.pages.providers.provider.common.fields.field.transcription.probability-of-speech.label')"
        :below-label="t('settings.pages.providers.provider.common.fields.field.transcription.probability-of-speech.below-label')"
        :above-label="t('settings.pages.providers.provider.common.fields.field.transcription.probability-of-speech.above-label')"
        :threshold-label="t('settings.pages.providers.provider.common.fields.field.transcription.probability-of-speech.threshold-label')"
      />

      <div class="space-y-3">
        <FieldRange
          v-model="speakingThreshold"
          :label="t('settings.pages.providers.provider.common.fields.field.transcription.sensitivity.label')"
          :description="t('settings.pages.providers.provider.common.fields.field.transcription.sensitivity.description')"
          :min="1"
          :max="80"
          :step="1"
      ...
      <div class="flex items-center gap-3">
        ...
        <span class="text-sm font-medium">
          {{ isSpeaking ? t('settings.pages.providers.provider.common.fields.field.transcription.speaking-indicator.speaking-detected') : t('settings.pages.providers.provider.common.fields.field.transcription.speaking-indicator.silence') }}
        </span>
      </div>
    </div>
  </div>
