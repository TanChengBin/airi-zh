        ...
        <div class="flex-1 cursor-pointer">
          ...
          <div class="mb-2 flex items-center justify-between">
            ...
            <button
              ...
              class="ml-2 rounded p-1 transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800"
              :class="[
            ...
            >
              <div v-if="currentlyPlayingId === voice.id" class="i-solar:pause-circle-bold-duotone text-lg" />
              <div v-else class="i-solar:play-circle-bold-duotone text-lg" />
            </button>
            <div
              v-else
              class="ml-2 text-xs text-neutral-400 italic dark:text-neutral-500"
            >
              No preview
            </div>
          </div>
