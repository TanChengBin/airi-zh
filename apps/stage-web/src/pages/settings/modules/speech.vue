...
const testText = ref(t('settings.pages.providers.provider.common.fields.field.default-test-text.text'))
const ssmlText = ref('')
...
async function generateTestSpeech() {
  ...
  try {
    ...
    errorMessage.value = error instanceof Error ? error.message : t('settings.pages.providers.provider.common.fields.field.error-messages.unknown-error')
  }
  finally {
    ...
    <div bg="neutral-100 dark:[rgba(0,0,0,0.3)]" rounded-xl p-4 flex="~ col gap-4" class="h-fit w-full md:w-[40%]">
          ...
          <div max-w-full>
            ...
            >
              <RadioCardSimple
                ...
                :value="metadata.id"
                :title="metadata.localizedName || t('settings.pages.providers.provider.common.fields.field.error-messages.unknown')"
            ...
            <div v-else>
              ...
              >
                ...
                <div class="flex flex-col">
                  <span class="font-medium">{{ t('settings.pages.providers.provider.common.fields.field.no-speech-providers.title') }}</span>
                  <span class="text-sm text-neutral-400 dark:text-neutral-500">{{ t('settings.pages.providers.provider.common.fields.field.no-speech-providers.description') }}</span>
                </div>
      ...
      <div v-if="activeSpeechProvider">
        <div flex="~ col gap-4">
          <div>
            <h2 class="text-lg text-neutral-500 md:text-2xl dark:text-neutral-400">
              {{ t('settings.pages.providers.provider.common.fields.field.voice-configuration.title') }}
            </h2>
            <div text="neutral-400 dark:neutral-500">
              <span>{{ t('settings.pages.providers.provider.common.fields.field.voice-configuration.description') }}</span>
            </div>
          </div>
          ...
          <ErrorContainer
            ...
            class="mb-2"
            :title="t('settings.pages.providers.provider.common.fields.field.error-loading-voices.title')"
          ...
          >
            <template #title>
              {{ t('settings.pages.providers.provider.common.fields.field.no-voices-available.title') }}
            </template>
            <template #content>
              {{ t('settings.pages.providers.provider.common.fields.field.no-voices-available.description') }}
            </template>
          </Alert>
          ...
          <div flex="~ col gap-4">
            ...
            <FieldCheckbox
              v-model="ssmlEnabled"
              :label="t('settings.pages.providers.provider.common.fields.field.ssml-enabled.label')"
              :description="t('settings.pages.providers.provider.common.fields.field.ssml-enabled.description')"
            />
          </div>
          ...
          >
            <FieldInput
              ...
              type="text"
              :label="t('settings.pages.providers.provider.common.fields.field.voice-id.label')"
              :description="t('settings.pages.providers.provider.common.fields.field.voice-id.description')"
              :placeholder="t('settings.pages.providers.provider.common.fields.field.voice-id.placeholder')"
            />

            <!-- Model selection for ElevenLabs -->
            <div v-if="activeSpeechProvider === 'elevenlabs'">
              <label class="mb-1 block text-sm font-medium">
                {{ t('settings.pages.providers.provider.common.fields.field.model.label') }}
              </label>
              <select
                v-model="activeSpeechModel"
              ...
              >
                <option value="eleven_monolingual_v1">
                  {{ t('settings.pages.providers.provider.common.fields.field.model-options.monolingual-v1') }}
                </option>
                <option value="eleven_multilingual_v1">
                  {{ t('settings.pages.providers.provider.common.fields.field.model-options.multilingual-v1') }}
                </option>
                <option value="eleven_multilingual_v2">
                  {{ t('settings.pages.providers.provider.common.fields.field.model-options.multilingual-v2') }}
                </option>
              </select>
            </div>
    ...
    <div flex="~ col gap-6" class="w-full md:w-[60%]">
      <div w-full rounded-xl>
        ...
        <div flex="~ col gap-4">
          <FieldCheckbox
            v-model="useSSML"
            :label="t('settings.pages.providers.provider.common.fields.field.use-custom-ssml.label')"
            :description="t('settings.pages.providers.provider.common.fields.field.use-custom-ssml.description')"
          />
          ...
          <template v-else>
            <textarea
              v-model="ssmlText"
              :placeholder="t('settings.pages.providers.provider.common.fields.field.ssml-text.placeholder')"
              border="neutral-100 dark:neutral-800 solid 2 focus:neutral-200 dark:focus:neutral-700"
              transition="all duration-250 ease-in-out"
              bg="neutral-100 dark:bg-neutral-800 focus:neutral-50 dark:focus:neutral-900"
          ...
          <div flex="~ row" gap-4>
            ...
            >
              <div flex="~ row" items-center gap-2>
                ...
                <span>{{ t('settings.pages.providers.provider.common.fields.field.stop.label') }}</span>
              </div>
            </button>
          </div>
